...
library HermesLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        // 940641180a2372e7a7d08779b9f0bad6a0e31179658a16260fcffc13a3af986d
                        hex"2b5c1f92763cc808d46f799ed176bc720efdf2600b6b6ba91296a61afd2aa00b" // init code fuji
                    )
                )
            )
        );
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IHermesPair(pairFor(factory, tokenA, tokenB)).getReserves();
    ...
    function quote(
        ...
        require(reserveA > 0 && reserveB > 0, "HermesLibrary: INSUFFICIENT_LIQUIDITY");
